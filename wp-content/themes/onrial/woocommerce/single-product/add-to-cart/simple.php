...
if ( $product->is_in_stock() ) : ?>
	...
	<form class="cart" method="post" enctype='multipart/form-data'>
		...
		?>
        <div class="product-filter__wrapper" style="text-align: right;">
            <button type="submit" name="add-to-cart" value="<?php echo esc_attr( $product->get_id() ); ?>" class="product-btn__order single_add_to_cart_button"><?php echo esc_html( $product->single_add_to_cart_text() ); ?></button>
        </div>
