<?php
/*
Template name: Landscape design
*/
get_header('landscape'); ?>

    <main class="land-wrapper">
        <section class="land-banner">
            <div class="container">
                <div class="land-banner__txt-wrap">
                    <span class="land-banner__title">Создаем дизайн и озеленение ландшафтов <br>с собственными растениями</span>
                    <div class="land-banner__descr">Даем гарантию на растения 365 дней</div>
                    <a href="" class="land-banner__btn">Обсудить проект</a>
                </div>
            </div>
        </section>
        <section class="land-adv__wrapper">
            <div class="container">
                <ul class="land-adv__list">
                    <li class="land-adv__item">
                        <i class="land-adv__icon ai1"></i>
                        <div class="land-adv__text-wrap">
                            <div class="land-adv__text">
                                4<span class="land-adv__text-sm"> га</span>
                            </div>
                            <span class="land-adv__descr">Самый крупный <br>объект</span>
                        </div>
                    </li>
                    <li class="land-adv__item">
                        <i class="land-adv__icon ai2"></i>
                        <div class="land-adv__text-wrap">
                            <div class="land-adv__text">
                                50+
                            </div>
                            <span class="land-adv__descr">Выполненных проектов</span>
                        </div>
                    </li>
                    <li class="land-adv__item">
                        <i class="land-adv__icon ai3"></i>
                        <div class="land-adv__text-wrap">
                            <div class="land-adv__text">
                                10<span class="land-adv__text-sm"> лет</span>
                            </div>
                            <span class="land-adv__descr">Работаем в <br>этой сфере</span>
                        </div>
                    </li>
                </ul>
            </div>
            ...
            <div class="container">
                ...
                <ul class="stages-list">
                    <li class="stages-item">
                        ...
                        <div class="stages-item__bot">
                            <span>Срок: </span>от 1 до 7 дней
                        </div>
                    </li>
                    <li class="stages-item">
                        <img class="stages-item__pic" src="<?php echo get_template_directory_uri();?>/images/landing/handshake-icon.png" alt="">
            ...
            <div class="container">
                ...
                <ul class="events-list">
                    <li class="events-item col-sm-6">
                        <a class="events-item__link" href="">
                ...
                <a class="events-btn" href="">Все события</a>
                <div class="clearfix"></div>
            </div>
        </section>
        <section class="request-wrapper">
            <span class="request-title">Оставьте заявку и мы предложим Вам несколько вариантов и идей</span>
