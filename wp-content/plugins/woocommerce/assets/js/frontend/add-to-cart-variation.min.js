...
;(function ( $, window, document, undefined ) {
			...
			if ( $( this ).is('.wc-variation-is-unavailable') ) {
				...
				$('.variations select').each(function(){
					if($(this).val() == ''){
						...
						$(this). css('border', '1px solid #d8dadb');
					}
				});
			}
		}
    ...
    $( '.variations_form.cart' ).on('found_variation', function(){
        $(this).find('.price').slideUp();
        $(this).find('.product-prices').slideUp();
    });

    $( '.variations_form.cart' ).on('reset_data', function(){
        $(this).find('.price').slideDown();
        $(this).find('.product-prices').slideDown();
    });
