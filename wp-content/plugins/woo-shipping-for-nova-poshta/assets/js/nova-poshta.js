jQuery(document).ready(function () {
    var NovaPoshtaOptions = (function ($) {
        ...
        var defaultBillingOptions = $('#billing_address_1, #billing_address_2, #billing_state, #billing_postcode');
        ...
        var shippingMethod = $("[name^=shipping_method]");
        ...
        var ensureNovaPoshta = function () {
            ...
            var value = $('input[name^=shipping_method][type=radio]:checked, select[name^=shipping_method]').val();
            if (!value) {
                value = $('input#shipping_method_0, select#shipping_method_0').val();
            }
