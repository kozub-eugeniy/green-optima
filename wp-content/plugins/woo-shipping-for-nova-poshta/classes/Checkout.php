...
class Checkout extends Base
{
    ...
    private function addNovaPoshtaFields($fields, $location)
    {
		...
		$regions = OptionsHelper::getList(Region::findAll(), false);
		$local_regions = array(
			'АРК' => 'АРК',
			'Вінницька' => 'Винницкая обл.',
			'Волинська' => 'Волынская обл.',
			'Дніпропетровська' => 'Днепропетровская обл.',
			'Донецька' => 'Донецкая обл.',
			'Житомирська' => 'Житомирская обл.',
			'Закарпатська' => 'Закарпатская обл.',
			'Запорізька' => 'Запорожская обл.',
			'Івано-Франківська' => 'Ивано-Франковская обл.',
			'Київська' => 'Киевская обл.',
			'Кіровоградська' => 'Кировоградская обл.',
			'Луганська' => 'Луганская обл.',
			'Львівська' => 'Львовская обл.',
			'Миколаївська' => 'Николаевская обл.',
			'Одеська' => 'Одесская обл.',
			'Полтавська' => 'Полтавская обл.',
			'Рівненська' => 'Ровенская обл.',
			'Сумська' => 'Сумская обл.',
			'Тернопільська' => 'Тернопольская обл.',
			'Харківська' => 'Харьковская обл.',
			'Херсонська' => 'Херсонская обл.',
			'Хмельницька' => 'Хмельницкая обл.',
			'Черкаська' => 'Черкасская обл.',
			'Чернівецька' => 'Черниговская обл.',
			'Чернігівська' => 'Черновицкая обл.'
		);
		foreach($regions as $key => $val){
			if(isset($local_regions[$val])){
				$regions[$key] = $local_regions[$val];
			}
		}
        $fields[Region::key($location)] = [
            ...
            'type' => 'select',
            'required' => $required,
            'default' => '71508131-9b87-11de-822f-000c2965ae0e',
            'options' => $regions,
            'class' => array(),
        ...
        $fields[City::key($location)] = [
            ...
            'type' => 'select',
            'required' => $required,
            'options' => OptionsHelper::getList(City::findByParentAreaRef($area), false),
            'class' => array(),
        ...
        $fields[Warehouse::key($location)] = [
            ...
            'type' => 'select',
            'required' => $required,
            'options' => OptionsHelper::getList(Warehouse::findByParentAreaRef($city), false),
            'class' => array(),
            'value' => '',
			'default' => '1ec09d88-e1c2-11e3-8c4a-0050568002cf',
            'custom_attributes' => array(),
        ];
        return $fields;
    }
