...
(function (factory) {
    ...
    YithAutocomplete.formatResult = function (suggestion, currentValue) {
        ...
        return suggestion.thumb + '<div>' + suggestion.value.replace(new RegExp(pattern, 'gi'), '<strong>$1<\/strong>') + '<span>' + suggestion.price + ' ГРН</span></div>';
    };
    ...
    YithAutocomplete.prototype = {
        ...
        suggest: function () {
			...
			html += '<button type="submit">ПОСМОТРЕТЬ ВСЕ РЕЗУЛЬТАТЫ</button>';
	...
	$(document).on('click', '.autocomplete-suggestions button', function(){
