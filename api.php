...
$token = '';
$domain = 'onrial.com.ua';
$sendTo = 'manager1@onrial.com.ua';
...
if (array_key_exists('data', $_POST)){
    ...
    if ((!isset($data->phone) || empty($data->phone->val)) && (!isset($data->email) || empty($data->email->val))) {
        header("HTTP/1.0 404 Not Found");
        echo '{"status":"error", "message":"Не заполнено поле для связи"}';
        die();
    }
